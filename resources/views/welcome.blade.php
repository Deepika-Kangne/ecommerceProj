...
<body>
    ...
    <!-- ALL PLUGINS -->
    <script src="js/plugin/jquery.superslides.min.js"></script>
    <script src="js/plugin/bootstrap-select.js"></script>
    <script src="js/plugin/inewsticker.js"></script>
    <script src="js/plugin/bootsnav.js."></script>
    <script src="js/plugin/images-loded.min.js"></script>
    <script src="js/plugin/isotope.min.js"></script>
    <script src="js/plugin/owl.carousel.min.js"></script>
    <script src="js/plugin/baguetteBox.min.js"></script>
    <script src="js/plugin/form-validator.min.js"></script>
    <script src="js/plugin/contact-form-script.js"></script>
